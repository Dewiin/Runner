...
#background_surface = pygame.transform.scale(background_surface, (960, 540))
...
#player_rect = player_surface.get_rect(midbottom = (player_x, 410))
...
while run:
    ...
    #player_rect.x += 4
    #if(player_rect.left > 1000) : player_rect.right = 0
